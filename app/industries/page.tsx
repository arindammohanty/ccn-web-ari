        ...
        <div className="animate-fade-in">
            <section className="bg-gradient-hero border-b border-white/10 pt-16 pb-20 relative overflow-hidden">
                <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
                    ...
                    <p className="text-lg text-slate-300 max-w-2xl mx-auto">Purpose-built infrastructure and services tailored to the unique regulatory and operational needs of your sector.</p>
                </div>
            </section>
            <section className="py-20 bg-slateBg text-center">
                <div className="container mx-auto px-6">
                    ...
                    <p className="text-slate-500 mt-2">Detailed industry breakdowns are currently under construction.</p>
                </div>
            </section>
        </div>
    );
