             ...
             <section className="bg-gradient-hero border-b border-white/10 pt-16 pb-20 relative overflow-hidden">
                <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
                    ...
                    <div className="relative max-w-xl mx-auto flex">
                        ...
                        <input type="text" placeholder="Search for help articles, services, or solutions..." className="w-full pl-10 pr-4 py-3 rounded-l-md text-sm border-0 focus:ring-2 focus:ring-primary shadow-lg" />
