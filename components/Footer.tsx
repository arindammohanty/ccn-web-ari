        ...
        <>
            <section className="bg-gradient-blue relative overflow-hidden py-16 mt-auto">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
                    ...
                    <Link href="/contact" className="bg-white text-slate-900 hover:bg-slate-100 px-6 py-3 rounded text-sm font-bold transition-colors inline-flex items-center shadow-lg whitespace-nowrap">Schedule Consultation &rarr;</Link>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 mb-16">
                        <div className="lg:col-span-2">
                            ...
                            <div className="flex space-x-3">
                                <Link href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-primary hover:text-white transition-colors"><i className="fa-brands fa-linkedin-in text-sm"></i></Link>
                                <Link href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-primary hover:text-white transition-colors"><i className="fa-brands fa-twitter text-sm"></i></Link>
                                <Link href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-primary hover:text-white transition-colors"><i className="fa-brands fa-youtube text-sm"></i></Link>
                                <Link href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-primary hover:text-white transition-colors"><i className="fa-regular fa-envelope text-sm"></i></Link>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-xs font-medium text-slate-400 mb-6">
                                ...
                                <li><Link href="/support/portal" className="hover:text-white transition-colors">Support Portal</Link></li>
                            ...
                            <Link href="/contact" className="w-full bg-primary/10 border border-primary/30 hover:bg-primary text-white py-2 rounded text-xs font-bold transition-colors flex items-center justify-center">Get in Touch &rarr;</Link>
                        </div>
                    </div>
